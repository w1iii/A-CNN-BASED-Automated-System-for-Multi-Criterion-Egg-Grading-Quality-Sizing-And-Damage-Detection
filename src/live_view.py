...
def main():
    ...
    class_names = ['Quality', 'Sizing', 'Damage'] # Adjust this to match your classes
    ...
    while True:
        ...
        overlay = frame.copy()
        cv2.putText(overlay, 'Press SPACE to grade this egg', (10,30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 2)
        ...
        if key == ord('q'):
            ...
            snapshot = frame.copy()
            cv2.putText(snapshot, result_str, (10,60), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,0,255), 3)
